...
export const CIRCLES: CircleConfig[] = [
  ...
  { id: 3, name: 'Gluttony', nameKo: '탐식', theme: '부패, 진흙, 공허', bgType: 'stone', depthStart: 300, depthEnd: 600,
    ...
    monsters: [ { monsterId: 'c3_devourer', chance: 0.05, weight: 1, minLayer: 1 }, { monsterId: 'c3_worm', chance: 0.03, weight: 1, minLayer: 2 }, { monsterId: 'c3_mud_shade', chance: 0.02, weight: 1, minLayer: 3 } ], boss: { id: 'c3_cerberus', spawnLayer: 4 } },
  { id: 4, name: 'Greed', nameKo: '탐욕', theme: '황금, 욕망, 차가운 빛', bgType: 'stone', depthStart: 600, depthEnd: 900,
    ...
    monsters: [{ monsterId: 'c4_hoarder', chance: 0.05, weight: 1, minLayer: 1 }], boss: { id: 'c4_plutus', spawnLayer: 4 } },
  { id: 5, name: 'Wrath', nameKo: '분노', theme: '용암, 불꽃, 격노', bgType: 'stone', depthStart: 900, depthEnd: 1200,
    ...
    monsters: [{ monsterId: 'c5_dweller', chance: 0.05, weight: 1, minLayer: 1 }], boss: { id: 'c5_phlegyas', spawnLayer: 4 } },
  { id: 6, name: 'Heresy', nameKo: '이단', theme: '재, 저주, 어둠', bgType: 'stone', depthStart: 1200, depthEnd: 1500,
    ...
    monsters: [{ monsterId: 'c6_priest', chance: 0.05, weight: 1, minLayer: 1 }], boss: { id: 'c6_farinata', spawnLayer: 4 } },
  { id: 7, name: 'Violence', nameKo: '폭력', theme: '피, 가시, 잔혹', bgType: 'stone', depthStart: 1500, depthEnd: 1800,
    ...
    monsters: [{ monsterId: 'c7_centaur', chance: 0.05, weight: 1, minLayer: 1 }], boss: { id: 'c7_minotaur', spawnLayer: 4 } },
  { id: 8, name: 'Fraud', nameKo: '사기', theme: '기만, 그림자, 이중성', bgType: 'stone', depthStart: 1800, depthEnd: 2100,
    ...
    monsters: [{ monsterId: 'c8_malebranche', chance: 0.05, weight: 1, minLayer: 1 }], boss: { id: 'c8_geryon', spawnLayer: 4 } },
