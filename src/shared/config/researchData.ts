...
export const RESEARCH_NODES: ResearchNode[] = [
  // --- Root Node ---
  {
    ...
    icon: '⚙️',
    cost: { goldCoins: 0 },
    effect: { type: 'attackPower', value: 0 },
    dependencies: [],
  },
  ...
  // --- Attack Power Path (UPWARDS Branch) ---
  {
    id: 'power_1',
    name: 'Sharpened Bits',
    description: 'Increases base attack power by 10.',
    icon: '⚔️',
    cost: { stone: 50, goldCoins: 1000 },
    effect: { type: 'attackPower', value: 10 },
    dependencies: ['root'],
  },
  {
    id: 'power_2',
    name: 'Tungsten Coating',
    description: 'Increases base attack power by 25.',
    icon: '🧨',
    cost: { iron: 100, goldCoins: 5000 },
    effect: { type: 'attackPower', value: 25 },
    dependencies: ['power_1'],
  },
  {
    id: 'power_3',
    name: 'Diamond Tipped',
    description: 'Increases base attack power by 60.',
    icon: '💎',
    cost: { diamond: 50, goldCoins: 20000 },
    effect: { type: 'attackPower', value: 60 },
    dependencies: ['power_1'],
  },
