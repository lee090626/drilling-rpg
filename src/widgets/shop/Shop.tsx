              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full shrink-0">
                ...
                {Array.from({ length: (stats.dimension || 0) + 1 }).map((_, tierIndex) => {
                  ...
                  return (
                    <div
                      key={tierIndex}
                      className="bg-zinc-900/60 backdrop-blur-xl border border-white/5 p-6 md:p-10 rounded-[2.5rem] md:rounded-[3.5rem] shadow-2xl relative overflow-hidden group flex flex-col items-center text-center transition-all hover:bg-zinc-800/80 hover:border-amber-500/30"
                    >
